...
> **Status (2026-07-31): CLOSED — campaign record.** Campaign complete; the library is sorry-free since 2026-07-04 (see [Blueprint/04-capstones.md](Blueprint/04-capstones.md), the proof-status SSOT). File links below have been repointed to the post-2026-04 folder layout (`L4YAML/Proofs/Production/`); line numbers, LOC figures, and sorry counts are as-of-campaign.
>
> Code snippets below predate the 2026-07-31 theorem→lemma rename: non-capstone `theorem` declarations are now spelled `lemma`.
...
**File:** [ScalarProduction.lean](L4YAML/Proofs/Production/ScalarProduction.lean) — extends existing Phase B infrastructure, reuses `peek_some_sp`, `advance_corr`, `consumeNewline_sbreak_corr`, `foldQuotedNewlines_prod`.
...
**File:** [NodeProduction.lean](L4YAML/Proofs/Production/NodeProduction.lean) — imports `ScalarProduction` + `StructureProduction`.
...
**File:** [DocumentProduction.lean](L4YAML/Proofs/Production/DocumentProduction.lean) — contains stream extension lemmas (§6a) and the precisely scoped sorry (§6b); parallels `ScanStrictCoupling.scanLoop_full_consumption` but with grammar accumulation. Import chain: `ScalarProduction → NodeProduction → DocumentProduction`.
...
**New files/sections:**
- [NodeProduction.lean](L4YAML/Proofs/Production/NodeProduction.lean) §6: GStar/GPlus lifting + anchor/alias converters (6 theorems, 61 lines)
- [ScalarProduction.lean](L4YAML/Proofs/Production/ScalarProduction.lean) §5: isPlainSafe bridge lemmas (6 theorems, 52 lines)
- [ScalarProduction.lean](L4YAML/Proofs/Production/ScalarProduction.lean) §6: Block header production (3 theorems, 55 lines)
...
**Files:**
- [ScalarProduction.lean](L4YAML/Proofs/Production/ScalarProduction.lean) — **0 sorry**. All `_prod` theorems fully proven (scanPlainScalar, scanBlockScalar, scanDoubleQuoted, scanSingleQuoted)
- [NodeProduction.lean](L4YAML/Proofs/Production/NodeProduction.lean) — extend with flow collection composition
- [DocumentProduction.lean](L4YAML/Proofs/Production/DocumentProduction.lean) — stream construction helpers, `scan_strict_proof` delegates to `scan_content_gives_stream_v2` (0 sorry)
- [PreprocessProduction.lean](L4YAML/Proofs/Production/PreprocessProduction.lean) — preprocessing → grammar coupling (sub-layer 4b)
- [StreamAccum.lean](L4YAML/Proofs/Production/StreamAccum.lean) — stream accumulator through scanLoop (sub-layers 4c→4d→4e: lagging quad with `BlockStack`)
...
**New files:**
- [PreprocessProduction.lean](L4YAML/Proofs/Production/PreprocessProduction.lean) — 280 lines, 8 theorems, 0 sorry
...
**New files:**
- [StreamAccum.lean](L4YAML/Proofs/Production/StreamAccum.lean) — 571 lines, `PendingNode` + `BlockStack` inductives + 11 theorems (5 per-dispatch sorry **architecturally provable**, 6 proven). Restructured through 4c→4d→4e: lagging quad with block collection accumulator.
