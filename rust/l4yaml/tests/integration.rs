//! Integration tests for the l4yaml safe Rust wrapper.
//!
//! These tests require `libl4yaml.so` to be built and discoverable.
//! Set `L4YAML_LIB_DIR` if it is not at `../../ffi/out/`.
//!
