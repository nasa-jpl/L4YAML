...
lemma isPlainSafe_empty : isPlainSafe "" = false := by native_decide

/-- Simple alphanumeric words are plain-safe. -/
lemma isPlainSafe_word : isPlainSafe "hello" = true := by native_decide
lemma isPlainSafe_number : isPlainSafe "42" = true := by native_decide
lemma isPlainSafe_mixed : isPlainSafe "hello123" = true := by native_decide

/-- Strings with spaces (interior only) are plain-safe. -/
lemma isPlainSafe_with_space : isPlainSafe "two words" = true := by native_decide

/-- Leading space is not plain-safe. -/
lemma isPlainSafe_leading_space : isPlainSafe " leading" = false := by native_decide

/-- Trailing space is not plain-safe. -/
lemma isPlainSafe_trailing_space : isPlainSafe "trailing " = false := by native_decide

/-- Newlines are not plain-safe. -/
lemma isPlainSafe_newline : isPlainSafe "line\nnewline" = false := by native_decide

/-- Colons followed by space are not plain-safe. -/
lemma isPlainSafe_colon_space : isPlainSafe "key: val" = false := by native_decide

/-- Space followed by `#` is not plain-safe (comment indicator). -/
lemma isPlainSafe_space_hash : isPlainSafe "word #comment" = false := by native_decide

/-- Flow indicators are not plain-safe. -/
lemma isPlainSafe_brace : isPlainSafe "{flow}" = false := by native_decide
lemma isPlainSafe_bracket : isPlainSafe "[arr]" = false := by native_decide

/-- YAML reserved words (boolean/null) are not plain-safe. -/
lemma isPlainSafe_true : isPlainSafe "true" = false := by native_decide
lemma isPlainSafe_false : isPlainSafe "false" = false := by native_decide
lemma isPlainSafe_null : isPlainSafe "null" = false := by native_decide
lemma isPlainSafe_tilde : isPlainSafe "~" = false := by native_decide
lemma isPlainSafe_Yes : isPlainSafe "Yes" = false := by native_decide
lemma isPlainSafe_NO : isPlainSafe "NO" = false := by native_decide

/-- Leading indicators (§5.3) are not plain-safe. -/
lemma isPlainSafe_dash : isPlainSafe "-item" = false := by native_decide
lemma isPlainSafe_question : isPlainSafe "?key" = false := by native_decide
lemma isPlainSafe_colon : isPlainSafe ":val" = false := by native_decide
lemma isPlainSafe_ampersand : isPlainSafe "&anchor" = false := by native_decide
lemma isPlainSafe_asterisk : isPlainSafe "*alias" = false := by native_decide
lemma isPlainSafe_bang : isPlainSafe "!tag" = false := by native_decide
lemma isPlainSafe_pipe : isPlainSafe "|literal" = false := by native_decide
lemma isPlainSafe_gt : isPlainSafe ">folded" = false := by native_decide
lemma isPlainSafe_squote : isPlainSafe "'quoted" = false := by native_decide
lemma isPlainSafe_dquote : isPlainSafe "\"quoted" = false := by native_decide
lemma isPlainSafe_percent : isPlainSafe "%directive" = false := by native_decide
lemma isPlainSafe_at : isPlainSafe "@reserved" = false := by native_decide
lemma isPlainSafe_backtick : isPlainSafe "`reserved" = false := by native_decide
...
lemma dump_config_doubleQuoted :
...
lemma dump_config_singleQuoted :
...
lemma dump_config_flow_override_map :
