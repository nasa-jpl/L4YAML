...
namespace L4YAML.Proofs.ScalarProduction
...
open L4YAML.Proofs.ScannerProgress (advance_offset_lt)
open L4YAML.Proofs.ScannerCorrectness (skipWhitespaceLoop_offset_ge)
