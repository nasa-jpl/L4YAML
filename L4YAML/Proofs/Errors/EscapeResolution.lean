...
-/
lemma resolveNamedEscape_count :
    ['\x00', 'a', 'b', 't', '\t', 'n', 'v', 'f', 'r', 'e',
     ' ', '"', '/', '\\', 'N', '_'].length = 16 := by
  native_decide

/-- `\0` → U+0000 (null) -/
lemma escape_null : resolveNamedEscape '0' = some '\x00' := by native_decide

/-- `\a` → U+0007 (bell) -/
lemma escape_bell : resolveNamedEscape 'a' = some '\x07' := by native_decide

/-- `\b` → U+0008 (backspace) -/
lemma escape_backspace : resolveNamedEscape 'b' = some '\x08' := by native_decide

/-- `\t` → U+0009 (horizontal tab) -/
lemma escape_tab : resolveNamedEscape 't' = some '\t' := by native_decide

/-- `\<TAB>` → U+0009 (horizontal tab, literal tab input) -/
lemma escape_tab_literal : resolveNamedEscape '\t' = some '\t' := by native_decide

/-- `\n` → U+000A (line feed) -/
lemma escape_linefeed : resolveNamedEscape 'n' = some '\n' := by native_decide

/-- `\v` → U+000B (vertical tab) -/
lemma escape_vtab : resolveNamedEscape 'v' = some '\x0b' := by native_decide

/-- `\f` → U+000C (form feed) -/
lemma escape_formfeed : resolveNamedEscape 'f' = some '\x0c' := by native_decide

/-- `\r` → U+000D (carriage return) -/
lemma escape_cr : resolveNamedEscape 'r' = some '\r' := by native_decide

/-- `\e` → U+001B (escape) -/
lemma escape_esc : resolveNamedEscape 'e' = some '\x1b' := by native_decide

/-- `\ ` → U+0020 (space) -/
lemma escape_space : resolveNamedEscape ' ' = some ' ' := by native_decide

/-- `\"` → U+0022 (double quote) -/
lemma escape_dquote : resolveNamedEscape '"' = some '"' := by native_decide

/-- `\/` → U+002F (slash) -/
lemma escape_slash : resolveNamedEscape '/' = some '/' := by native_decide

/-- `\\` → U+005C (backslash) -/
lemma escape_backslash : resolveNamedEscape '\\' = some '\\' := by native_decide

/-- `\N` → U+0085 (next line, NEL) -/
lemma escape_nel : resolveNamedEscape 'N' = some '\x85' := by native_decide

/-- `\_` → U+00A0 (non-breaking space) -/
lemma escape_nbsp : resolveNamedEscape '_' = some '\xa0' := by native_decide
...
lemma escape_hex8_none : resolveNamedEscape 'x' = none := by native_decide

/-- `\u` is a hex escape, not a named escape. -/
lemma escape_hex16_none : resolveNamedEscape 'u' = none := by native_decide

/-- `\U` is a hex escape, not a named escape. -/
lemma escape_hex32_none : resolveNamedEscape 'U' = none := by native_decide
...
lemma escape_tab_printable : isPrintableProp '\t' := by native_decide
...
lemma escape_cr_isLineBreak : isLineBreakProp '\r' := by native_decide

/-- Line feed is a line break character. -/
lemma escape_lf_isLineBreak : isLineBreakProp '\n' := by native_decide

/-- Space output is YAML-printable. -/
lemma escape_space_printable : isPrintableProp ' ' := by native_decide

/-- Double quote output is YAML-printable. -/
lemma escape_dquote_printable : isPrintableProp '"' := by native_decide

/-- Slash output is YAML-printable. -/
lemma escape_slash_printable : isPrintableProp '/' := by native_decide

/-- Backslash output is YAML-printable. -/
lemma escape_backslash_printable : isPrintableProp '\\' := by native_decide

/-- NEL (U+0085) output is YAML-printable. -/
lemma escape_nel_printable : isPrintableProp '\x85' := by native_decide

/-- Non-breaking space (U+00A0) output is YAML-printable. -/
lemma escape_nbsp_printable : isPrintableProp '\xa0' := by native_decide

/-- The replacement character U+FFFD is YAML-printable. -/
lemma replacement_char_printable : isPrintableProp '\uFFFD' := by native_decide
...
lemma escape_null_not_printable : ¬ isPrintableProp '\x00' := by native_decide

/-- Bell (U+0007) is not YAML-printable. -/
lemma escape_bell_not_printable : ¬ isPrintableProp '\x07' := by native_decide

/-- Backspace (U+0008) is not YAML-printable. -/
lemma escape_backspace_not_printable : ¬ isPrintableProp '\x08' := by native_decide

/-- Vertical tab (U+000B) is not YAML-printable. -/
lemma escape_vtab_not_printable : ¬ isPrintableProp '\x0b' := by native_decide

/-- Form feed (U+000C) is not YAML-printable. -/
lemma escape_formfeed_not_printable : ¬ isPrintableProp '\x0c' := by native_decide

/-- Escape (U+001B) is not YAML-printable. -/
lemma escape_esc_not_printable : ¬ isPrintableProp '\x1b' := by native_decide

/-- Line feed (U+000A) is not YAML-printable. Appears as a line break. -/
lemma escape_lf_not_printable : ¬ isPrintableProp '\n' := by native_decide
...
-/
lemma resolveNamedEscape_valid_unicode (c : Char) (r : Char)
...
-/
lemma resolveNamedEscape_deterministic (c : Char) (r₁ r₂ : Char)
...
lemma isNamedEscapeChar_null      : isNamedEscapeChar '0'  := by native_decide
lemma isNamedEscapeChar_bell      : isNamedEscapeChar 'a'  := by native_decide
lemma isNamedEscapeChar_backspace : isNamedEscapeChar 'b'  := by native_decide
lemma isNamedEscapeChar_tab       : isNamedEscapeChar 't'  := by native_decide
lemma isNamedEscapeChar_tab_lit   : isNamedEscapeChar '\t' := by native_decide
lemma isNamedEscapeChar_linefeed  : isNamedEscapeChar 'n'  := by native_decide
lemma isNamedEscapeChar_vtab      : isNamedEscapeChar 'v'  := by native_decide
lemma isNamedEscapeChar_formfeed  : isNamedEscapeChar 'f'  := by native_decide
lemma isNamedEscapeChar_cr        : isNamedEscapeChar 'r'  := by native_decide
lemma isNamedEscapeChar_esc       : isNamedEscapeChar 'e'  := by native_decide
lemma isNamedEscapeChar_space     : isNamedEscapeChar ' '  := by native_decide
lemma isNamedEscapeChar_dquote    : isNamedEscapeChar '"'  := by native_decide
lemma isNamedEscapeChar_slash     : isNamedEscapeChar '/'  := by native_decide
lemma isNamedEscapeChar_backslash : isNamedEscapeChar '\\' := by native_decide
lemma isNamedEscapeChar_nel       : isNamedEscapeChar 'N'  := by native_decide
lemma isNamedEscapeChar_nbsp      : isNamedEscapeChar '_'  := by native_decide
lemma isNamedEscapeChar_lsep      : isNamedEscapeChar 'L'  := by native_decide
lemma isNamedEscapeChar_psep      : isNamedEscapeChar 'P'  := by native_decide

/-- Hex escape prefixes are NOT named escapes. -/
lemma not_isNamedEscapeChar_x : ¬isNamedEscapeChar 'x' := by native_decide
lemma not_isNamedEscapeChar_u : ¬isNamedEscapeChar 'u' := by native_decide
lemma not_isNamedEscapeChar_U : ¬isNamedEscapeChar 'U' := by native_decide

/-- `isNamedEscapeChar` iff `resolveNamedEscape` returns `some`. -/
lemma isNamedEscapeChar_iff_isSome (c : Char) :
