     ...
     3. **2d-key-chain-Part2-body-C (compose + dispatch in
        ...
        * **C-foundation-EmitScansInFlow** — scope investigation
          ...
          6. **C-foundation-EmitScansInFlow-preservation-chain**
             ...
             independently of any other sub-step.
          ...
          + discharge-colon, with 1 remaining optional follow-on)
          underestimated the helper-level preservation work plus
          the stack-restore machinery.  With **discharge-colon**
          landed (sorry count 10), **C-compose** (~0.5–1 step,
          mechanical) is now unblocked.  **preservation-chain** is
          independent (orthogonal cleanup of
          `scanDoubleQuoted_preserves_pendingKeyStack_sorry`).
