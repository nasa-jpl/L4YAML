              ...
              - 6c-ii-γ-3b-ii. **chain-side flow-context kind restriction**
                ...
                **Decomposition rationale (2026-05-04):** the original
                ...
                into four smaller cadences:
                  ...
                  - 6c-ii-γ-3b-ii-leaves-B (PENDING).  Add new-kind conjunct
                    to `scanNextToken_flow_close_seq_nested` (`]`) +
                    `scanNextToken_flow_close_map_nested` (`}`) +
                    `scanNextToken_flow_comma` (`,`).  Discharge similarly
                    using foundation + per-leaf `_preserves_pendingKeys`
                    chains.  ~100 lines; no sorry change.
