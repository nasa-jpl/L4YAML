...
/-- Parse a YAML string into an array of documents with limit enforcement.
    ...
    Caller inspects the result via `lean4yaml_result_is_ok` etc. -/
@[export lean4yaml_parse_safe]
...
@[export lean4yaml_parse_single_safe]
...
@[export lean4yaml_result_get_error]
...
@[export lean4yaml_result_single_get_error]
...
@[export lean4yaml_value_as_string]
